...
var uastrings = []struct {
	...
	// Internet Explorer
	{
		...
		expectedOS: makeOSInfo("Windows 8", "Windows", "8"),
	},
	{
		title:    "Tablet",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Windows Phone OS 7.0", "Windows Phone OS", "7.0"),
	},
	{
		title:      "IE6",
		...
		expectedOS: makeOSInfo("Windows 2000", "Windows", "2000"),
	},
	{
		...
		expectedOS: makeOSInfo("Windows 7", "Windows", "7"),
	},
	{
	...
	},
	{
		...
		expectedOS: makeOSInfo("Windows 8.1", "Windows", "8.1"),
	},
	{
		title:    "IE11Win7",
	...
	// Microsoft Edge
	{
		...
		expectedOS: makeOSInfo("Windows 10", "Windows", "10"),
	},
	{
		title:    "EdgeMobile",
	...
	// Gecko
	{
		...
		expectedOS: makeOSInfo("Intel Mac OS X 10.6", "Mac OS X", "10.6"),
	},
	{
		title:      "FirefoxMacLoc",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Linux x86_64", "Linux", ""),
	},
	{
		...
		expectedOS: makeOSInfo("Ubuntu", "Ubuntu", ""),
	},
	{
		title:      "FirefoxWin",
		...
		expectedOS: makeOSInfo("Windows XP", "Windows", "XP"),
	},
	{
		title:    "Firefox29Win7",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Intel Mac OS X", "Mac OS X", ""),
	},
	{
		title:      "Iceweasel",
		...
		expectedOS: makeOSInfo("Linux i686", "Linux", ""),
	},
	{
		title:    "SeaMonkey",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Android", "Android", ""),
	},
	{
		title:      "FirefoxOS",
		...
		expectedOS: makeOSInfo("FirefoxOS", "FirefoxOS", ""),
	},
	{
	...
	},
	{
		...
		expectedOS: makeOSInfo("Windows XP x64 Edition", "Windows", "XP"),
	},
	{
		title:    "FirefoxMRA",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Windows Vista", "Windows", "Vista"),
	},
	{
		title:    "OperaMinimal",
		ua:       "Opera/9.80",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Linux", "Linux", ""),
	},
	{
		title:    "OperaNested",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Intel Mac OS X 10_6_5", "Mac OS X", "10.6.5"),
	},
	{
		title:    "SafariMac",
	...
	},
	{
		...
		expectedOS: makeOSInfo("CPU iPhone OS 7_0_3 like Mac OS X", "iPhone OS", "7.0.3"),
	},
	{
		title:    "iPhone",
	...
	},
	{
		...
		expectedOS: makeOSInfo("BlackBerry 9800", "BlackBerry", "9800"),
	},
	{
		title:    "BB10",
	...
	},
	{
		...
		expectedOS: makeOSInfo("SymbianOS/9.4", "SymbianOS", "9.4"),
	},
	{
		title:    "ChromeAndroid",
	...
	},
	{
		...
		expectedOS: makeOSInfo("Android 4.4.2", "Android", "4.4.2"),
	},
	{
		title:    "Dalvik - W2430",
	...
	{
		title:    "Yunaq",
		ua:       "Mozilla/5.0 (compatible; YunaqMonitor; +http://www.yunaq.com/help/56c54b80eb5fcf6c9d203b37/)",
		expected: "Mozilla:5.0 Browser:YunaqMonitor Bot:true Mobile:false",
	},
	{
		title:    "tsinghua",
		ua:       "TsinghuaSpider/1.0",
		expected: "Browser:TsinghuaSpider Bot:true Mobile:false",
	},
}
...
func beautify(ua *useragent.UserAgent) (s string) {
	if len(ua.Mozilla()) > 0 {
